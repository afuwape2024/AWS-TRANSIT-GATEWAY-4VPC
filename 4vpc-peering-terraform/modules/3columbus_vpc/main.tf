...
#==================================================================
resource "aws_subnet" "columbus_vpc_public_subnet_0" {
  ...
  tags = {
    Name = "columbus_vpc_public_subnet_0"
  }
}

resource "aws_subnet" "columbus_vpc_public_subnet_1" {
  vpc_id                  = aws_vpc.columbus_vpc.id
  ...
  tags = {
    Name = "columbus_vpc_public_subnet_1"
  }
}
